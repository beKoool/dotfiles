...
-- abckeys = gears.table.join(
--     awful.key({ modkey  }, "b", function() wibar.visible = not wibar.visible end,
...
-- )
    ...
    s.wibar:setup {
        ...
        { -- Right widgets
            layout = wibox.layout.fixed.horizontal,
            wibox.layout.margin(battery_widget{ show_current_level = true, font = "Sarasa Mono K Bold 11" }, 7,7,7,7),
	        wibox.layout.margin(volume{ widget_type = 'icon-and-text', font = "Sarasa Mono K Bold 11" },6,6,6,6),
